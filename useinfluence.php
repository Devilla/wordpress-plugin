...
function pluginAdminScreen() {
	...
	echo "</a>";
	echo "<br />";
  echo "<a href='https://useinfluence.co' class='describe' style='font-family:sans-serif;padding: 10px;border-left:  5px solid  #999;background: #99999930;'>If you don't have an account - signup here!</a>";
	echo "<a>";
